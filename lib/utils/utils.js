(function () {
    ...
    _.values = function values(obj) {
        ...
        return _.reduce(obj, function onValuesReduce(mem, value) {
            mem.push(value);
            return mem;
        }, []);
    };
    ...
    _.getElement = function getElement(el) {
        ...
        return is_by_id ? document.querySelector(el) : document.querySelectorAll(el);
    };

    _.setElementStyle = function setElementStyle(selector, style) {
        ...
        if (!_.isString(style)) {
            throw new Error('Expected style to be of type "Object" or "String." Instead received ' + typeof style);
        }
    ...
    _.setXHRHeaders  = function setXHRHeaders(xhr, headers) {
        ...
        headers = _.merge(DEFAULTS, headers);
