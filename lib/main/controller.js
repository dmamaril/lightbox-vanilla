...
(function () {
     ...
     * @return {undefined}
     */
    controller.openModal = function openModal() {
     ...
     * @return {undefined}
     */
    controller.navigateLightBox = function navigateLightBox() {
     ...
     * @return {undfined}
     */
    controller.loadImg = function loadImg(direction) {
    ...
    function fetchImages(query, image_batch) {
        ...
        function onGetResponse(err, images) {
            ...
            } else if (state.load_visible === true && state.num_images >= 100) {
